<div id="overlayer">
    <img class="logo" src="./img/scm_logo_lg_1.png">
    ...
    <svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        ...
        <g id="table_legs">
            <g>
                ...
                <rect x="47.2" y="626.1"
                    style="clip-path:url(#SVGID_2_);fill:#EDCF94;stroke:#0B0B0B;stroke-miterlimit:10;" width="34"
                    height="56.4" />

                <rect x="850.5" y="626.6"
                    style="clip-path:url(#SVGID_2_);fill:#EDCF94;stroke:#0B0B0B;stroke-miterlimit:10;" width="281.4"
                    height="49.9" />
        ...
        C598.5,521.9,599.6,521.3,601,521L601,521z" />
            <image xlink:href="./img/scm_logo_lg_1.png" x="493.3" y="306.1" height="167px" width="202px"/>
        </g>
        <g id="keyboard">
        ...
        <g id="lamp">
            ...
            198.6,342.1   " />
                    ...
                    <g id="lamp-head">
                        <ellipse style="fill:#228370;stroke:#0B0B0B;stroke-miterlimit:10;" cx="193.8" cy="347.5"
                            rx="18.5" ry="19.3" />
